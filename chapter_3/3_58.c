...
rguments: p1 at %ebp+8, p2 at %ebp+12, action at %ebp+16 Registers: result in %edx (initialized to -1)
The jump targets:
1 .L17:                 MODE_E
2 movl $17, %edx        %edx = result = 17
3 jmp .L19              
4 .L13:                 MODE_A
...
15 movl %eax, %edx      %edx = *p2
16 movl 8(%ebp), %ecx   %ecx = p1
17 addl (%ecx), %edx    %edx = *p1 + *p2
18 movl 12(%ebp), %eax  %eax = p2
19 movl %edx, (%eax)    *p2 = *p1 + *p2
20 jmp .L19
21 .L15:                MODE_C
